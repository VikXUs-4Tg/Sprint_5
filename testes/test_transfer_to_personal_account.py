...
class TestTransferToPersonalAccount:
    ...
    def test_transfer_to_personal_account_by_click_button_personal_account(self, authorized_driver, wait_timer, button_pass_from_constructor_window_to_personal_account, title_info_personal_account):
